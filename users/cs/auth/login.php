            ...
            <div class="col-lg-5">
              <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                  <h3 class="text-center font-weight-light my-4">Login as Cleaning Service</h3>
                </div>
                <div class="card-body">
                  ...
                  <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <div class="form-group mt-4 mb-0">
                      <input type="submit" name="login_cs" class="btn btn-primary btn-block py-2" value="Login">
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center">
                  <div class="small pt-3 pb-1 border-top"><a href="../../../index.php">&lt; Back to Home</a></div>
                </div>
              </div>
            </div>
          </div>
